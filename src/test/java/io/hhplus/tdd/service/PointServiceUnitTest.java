...
class PointServiceUnitTest {
    ...
    void 포인트_사용시_잔고가_부족하면_RuntimeException을_던진다() {
        ...
        pointService.chargePoints(id, 1000L);
    ...
    void 포인트_충전_또는_사용_이력이_있는_경우_포인트_내역_조회에_성공한다() {
        ...
        Optional<List<PointHistory>> pointHistoryOptional = pointService.findHistory(id);
    ...
    void 포인트_충전에_성공한다() {
        ...
        // when: 포인트 충전
        UserPoint userPoint = pointService.chargePoints(id, 10000L);
    ...
    void 충전할_포인트가_음수이거나_0이면_충전에_실패한다() {
        ...
        Assertions.assertEquals(1000L, pointService.findPoints(7L).get().points());
    }
    ...
    void 포인트_사용에_성공한다() {
        ...
        UserPoint userPoint = pointService.usePoints(id, amountToUse);
    ...
    void 잔고_부족으로_포인트_사용에_실패한다() {
        ...
        Assertions.assertEquals("잔고가 부족합니다.", exception.getMessage());
        Assertions.assertEquals(10000L, pointService.findPoints(9L).get().points());
    }
